...
int main(int argc, char *argv[]) {
	...
	cout << "a.method_2('c') ";
	a.method_2('c');	// a) keine Fehlermeldung; b) Ausgabe: a.method_2("c"): A::method_2(string) ?? Richtig -> (double)
	cout << "b.method_2('c') ";
	...
	//b.method_2("string"); // a) Fehlermeldung string kann nicht an Int parameter übergeben werden b) --
	cout << "a.method_3(1) ";
	...
	cout << "b.method_3('c') ";
	b.method_3('c');	// a) keine Fehlermeldung; b) Ausgabe: b.method_3("c"): B::method_3(string) ?? Richtig -> (int)
...
//-------------------------------------------------------------------
//A::method_2(double) | überlädt					| A::method_2(string)
//B::method_2(int)		| verdeckt					| A::method_2(string) & A::method_2(double)
//A::method_3(char)		| überlädt					| A::method_3(string)
//B::method_3(int) & B::method_3(string) |  verdeckt| A::method_3(string) & A::method_3(char)
//B::method_3(int)		| überlädt 					| B::method_3(string)
//
